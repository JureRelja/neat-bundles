import type { RGBColor } from "@shopify/polaris";
import { ColorPicker, Popover, Text, InlineStack, BlockStack, TextField, Box, hsbToHex, rgbToHsb } from "@shopify/polaris";
...
export default function Index({
    ...
    const [HSBColor, setHSBColor] = useState(rgbToHsb(hexToRgb(color) as RGBColor));

    useEffect(() => {
        updateColor(hsbToHex(HSBColor), colorId);
    }, [HSBColor, colorId, updateColor]);
