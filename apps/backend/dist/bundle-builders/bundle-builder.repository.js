...
const _server = /*#__PURE__*/ _interop_require_default(require("@db/server"));
...
let BundleBuilderRepository = class BundleBuilderRepository {
    async create(createBundleBuilderDto) {
        const bundleBuilder = await _server.default.bundleBuilder.create({
            data: {
    ...
    async delete(id) {
        return await _server.default.bundleBuilder.update({
            where: {
                id: id
            },
            data: {}
    ...
    async get(id, shop) {
        return _server.default.bundleBuilder.findUnique({
            where: {
                id: id,
                shop: shop
            }
    ...
    async getWithSteps(id, shop) {
        return await _server.default.bundleBuilder.findUnique({
            where: {
                id: id
            },
            include: {
    ...
    async getAll(shop) {
        return await _server.default.bundleBuilder.findMany({
            where: {
                shop: shop
            }
        });
    ...
    async getCount(shop) {
        return _server.default.bundleBuilder.count({
            where: {
                shop: shop
            }
        });
